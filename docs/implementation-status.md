...
| LP（`/`）を design.md の配色で刷新（src/features/landing、LP 限定トークン） | ✅ 2026-09-09 | `pnpm check` + `pnpm test:e2e` + Playwright で 320/393/768/1280px の横スクロール無し・`/signin` に `--lp-*` が漏れないことを確認 |
